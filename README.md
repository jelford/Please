...
`Please` is a prototype code-gen library that adds type-safety and convenience to the introspection operations required to gain access to private methods:
